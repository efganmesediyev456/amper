...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.weekly_selections.update', $item->id) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="tab-pane fade show @if($loop->first) active @endif"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="Başlıq daxil edin" value="{{$item->getTranslation('title', $language->code)}}">
                                </div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" name="start_date" id="start_date" 
                                       value="{{ date('Y-m-d\TH:i', strtotime($item->start_date)) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" name="end_date" id="end_date" 
                                       value="{{ date('Y-m-d\TH:i', strtotime($item->end_date)) }}" required>
                            </div>
                        </div>
                    </div>
