...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.categories.update', $item->id)}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted d-block my-2">Tövsiyə olunan ölçü: 32x32 piksel</small>
