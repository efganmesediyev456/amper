    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Vakansiya Paylaşım Sosial</h4>
                <div class="buttons">
                    <a href="{{ route('admin.vacancy-share-socials.index') }}" class="btn btn-success">Geriyə qayıt</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.vacancy-share-socials.store') }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
