    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="buttons">
                    <a href="{{ route('admin.blognews.index') }}" class="btn btn-success">Geriyə qayıt</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form action="{{route('admin.blognews.store')}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
