    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Yeni Alt Kateqoriya - {{ $category->title ?  $category->title : 'N/A' }}</h4>
                <div class="buttons">
                    <a href="{{ route('admin.categories.subcategories.index', $category->id) }}" class="btn btn-success d-flex align-items-center gap-2">
        ...
        <div class="card-body">
            <form action="{{ route('admin.categories.subcategories.store', $category->id) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
