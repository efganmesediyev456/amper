    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Alt kateqoriya Düzəliş - {{ $item->title }}</h4>
                <div class="buttons">
        ...
        <div class="card-body">
            <form action="{{ route('admin.categories.subcategories.update', [$category->id, $item->id]) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
