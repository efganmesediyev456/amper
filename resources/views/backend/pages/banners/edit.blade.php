...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.banners.update', $item->id) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3 mt-3">
                    ...
                    @if($item->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/'.$item->image) }}" alt="Banner Image" style="max-height: 200px; max-width: 100%;">
                        </div>
                    @endif
                    <input type="file" class="form-control" name="image" id="image">
                    <small class="text-muted">Tövsiyə olunan ölçü: 736x524 piksel</small>
                </div>
