...
class CertificatesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($user) {
                ...
                $edit = '<a href="'.route('admin.certificates.edit', $user->id).'" class="btn  btn-sm fs-5"><i class="fas fa-edit"></i></a>';
                $delete = '<form action="' . route('admin.certificates.destroy', $user->id) . '" method="POST" class="delete-form">
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->selectStyleSingle()
            ->columnDefs([
                ['targets' => 0, 'visible' => true, 'searchable' => false, 'orderable' => false, 'className' => 'noVis']
            ])
            ->parameters([
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(Certificate::class)."'
                                },
